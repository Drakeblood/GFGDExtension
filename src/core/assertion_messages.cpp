...
String AssertionMessages::get_message_with_expected(const String& failure_message, const String& expected)
{
...
{
	return get_message_with_expected(String("Values are ") + String(expect_equal ? "not " : "") + String("equal."), 
...
{
	return get_message_with_expected(String("Value was ") + String(expect_null ? "not " : "") + String("Null"),
		String("Value was ") + String(expect_null ? "" : "not ") + String("Null"));
}

String AssertionMessages::boolean_failure_message(bool expected)
{
	return get_message_with_expected(String("Value was ") + String(!expected ? "" : "not ") + String("true"), String(expected ? "true" : "false"));
}
...
void AssertionMessages::_bind_methods()
{
	...
	ClassDB::bind_static_method("AssertionMessages", D_METHOD("get_message_with_expected", "failure_message", "expected"), &AssertionMessages::get_message_with_expected);
