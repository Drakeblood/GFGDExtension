...
{
	GDVIRTUAL_CALL(_init_level, scene_tree);
}

void Level::_bind_methods()
{
	ClassDB::bind_method(D_METHOD("get_game_mode_settings_override"), &Level::get_game_mode_settings_override);
	ClassDB::bind_method(D_METHOD("set_game_mode_settings_override", "settings"), &Level::set_game_mode_settings_override);
	...
	GDVIRTUAL_BIND(_init_level, "scene_tree");
}
}
